...
public class CreateQueryExecutor {
    ...
    protected Response createSchema(Request request) {
        LOGGER.info("Creating Schema: {}", request.getEntityType());
        String schemaFile = request.getEntityName();
    ...
    protected Response createTable(Request request) {
        LOGGER.info("Creating Table: {}", request.getEntityName());
        String tableSchema = request.getHeader().get("schema");
        String tableFile = request.getEntityName();
    ...
    private void writeTableMetadata(Request request, File file) {
        ...
        try {
            ...
            for (Column column : columns) {
                ...
                writer.writeCharacters(column.getSqlDataType().getDataType());
